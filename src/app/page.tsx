...
import { serviceGroups, products, reasons } from "@/lib/data";
        ...
        <div className="mx-auto max-w-6xl px-4 py-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {products.slice(0, 4).map((p) => (
              <Link key={p.name} href="/products" className="group">
                ...
                <p className="font-mono text-sm text-neutral-600">R{p.price.toLocaleString("en-US")}</p>
              </Link>
            ))}
          </div>
        </div>
